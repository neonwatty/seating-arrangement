...
- generic [ref=e1]:
  ...
  - generic [ref=e152]:
    - generic [ref=e153]:
      - heading "The Canvas" [level=3] [ref=e154]
      - paragraph [ref=e155]: This is your floor plan. Drag tables to arrange them, zoom with scroll, and pan by holding Shift while dragging.
    - generic [ref=e164]:
      - button "Back" [ref=e165] [cursor=pointer]
      - button "Skip" [ref=e166] [cursor=pointer]
      - button "Next" [active] [ref=e167] [cursor=pointer]
```